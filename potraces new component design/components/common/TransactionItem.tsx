...
const TransactionItem: React.FC<TransactionItemProps> = ({
  ...
  const content = (
    ...
    >
      {/* NEU: raised surface at rest, pushed-in on press */}
      <Animated.View style={[
        styles.card,
        pressed ? neu.inset : neu.raised,
        { opacity: opacityAnim },
...
const makeStyles = (C: typeof CALM) => StyleSheet.create({
  // NEU: layout only — surface (bg + dual shadow) comes from useNeu().raised.
  card: {
    flexDirection: 'row',
    ...
    marginBottom: SPACING.sm + 6, // a touch more gap so the soft shadow can breathe
  },
  cardSelected: {
